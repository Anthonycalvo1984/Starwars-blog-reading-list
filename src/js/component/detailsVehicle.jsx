                    ...
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                ...
                                <p className="card-text"><small className="text-muted">Model: {vehicle.model} <br />Length: {vehicle.length} <br />Max. Speed: {vehicle.max_atmosphering_speed} <br />Cargo Capacity: {vehicle.cargo_capacity} <br />Class: {vehicle.vehicle_class}<br />Manufacturer: {vehicle.manufacturer} </small></p>
                            </div>
                        </div>
                    </div>
                </div>
